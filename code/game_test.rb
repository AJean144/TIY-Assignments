...
#Deck
  #The deck should have a 2,3,4,5,6,7,8,9,10 and then face cards like jack, queen, king and ace. 
  #Each face card is the same as 10 except for the ace which is 11.
  #The deck will have these values for times in the deck.
...
#Hand
  ...
  #If hand gets more than 21 then hand loses
